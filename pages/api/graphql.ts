...
const { BRANCH, GRAPHCMSURL, GRAPHCMSPROJECTID, GRAPHCMS_TOKEN } = serverRuntimeConfig.graphcms;

const graphqlEndpoint = `${GRAPHCMSURL}/${GRAPHCMSPROJECTID}/${BRANCH}`;

export const graphQLClient = new GraphQLClient(graphqlEndpoint, {headers: {
